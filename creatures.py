...
class Beer(Creatures):
	def __init__(self):
		Creatures.__init__(self, name = "Milwuakee's Best", hp = 100, attack = 50)
	def art(self):
		return '''
             _, . '__ . 
          '_(_0o),(__)o().
...
class Zookeeper(Creatures):
	def __init__(self):
		Creatures.__init__(self, name = "Zookeeper", hp = 100, attack = 50)
	def art(self):
		return '''
                                  \\\\\\\////										
                             \\//\/\\\\\\\///										
