...
'''
    ...
    input_s("You scan the room. It appears mostly empty apart from a dusty bookshelf that seems to contain questionably old and outdated textbooks.", player)
    ...
    while decision not in ['leave','search']:
       	decision=input_s(sass.sample_sass(), player, "purple")
